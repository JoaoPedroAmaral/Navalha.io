...
function MetricCard({
  ...
  return (
    <div
      className={`bg-white rounded-xl border-l-4 ${borderClass} shadow-sm p-4 sm:p-5 flex items-center gap-3 sm:gap-4 min-w-0`}
    >
      <div
        className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center shrink-0 ${colorClass}`}
      >
      ...
      <div className="min-w-0">
        ...
        <p className="text-xs text-gray-500 mt-1 uppercase tracking-wide font-medium truncate">
          {label}
        </p>
      </div>
    </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {todayAppts.map((appt) => (
                  ...
                  >
                    <td
                      className="px-3 py-2.5 sm:px-5 sm:py-3.5 font-mono text-xs sm:text-sm font-semibold text-gray-700"
                      data-label="Horário"
                    >
